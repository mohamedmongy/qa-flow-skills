...
A **whole Postman collection or Swagger/OpenAPI spec** (many endpoints at once) is not this skill's territory — hand it to **qa-flow-collection-import** ([ai-rules/negotiation/collection-import.md](ai-rules/negotiation/collection-import.md)); a single cURL / one endpoint stays here.
